from lspy.evaluation.deltaeval.delta_multi_neighbourhood \
    import delta_multi_neighbourhood
from lspy.evaluation.deltaeval.delta_tsp import delta_tsp
from lspy.evaluation.deltaeval.delta_qap import delta_qap
