...
import itertools
import numpy
from lspy.localsearch.move.abstract_move \
    import AbstractMove
...
class MultiNeighbourhood(AbstractMove):
    ...
    .. doctest::
        ...
        >>> import numpy
        >>> from lspy.localsearch.move.array_swap import ArraySwap
    ...
    .. doctest::
        ...
        >>> from lspy.localsearch.move.multi_neighbourhood \\
        ...     import MultiNeighbourhood
        >>> from lspy.evaluation.quadratic_assignment_evaluation_function \\
