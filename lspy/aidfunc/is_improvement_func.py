...
def bigger(old_value, value):
    ...
    .. doctest::
        ...
        >>> from lspy.aidfunc.is_improvement_func import bigger
        >>> bigger(2, 5)
        True
        >>> bigger(5, 2)
        False
...
def smaller(old_value, value):
    ...
    .. doctest::
        ...
        >>> from lspy.aidfunc.is_improvement_func import smaller
        >>> smaller(2, 5)
        False
        >>> smaller(5, 2)
        True
...
def bigger_or_equal(old_value, value):
    ...
    .. doctest::
        ...
        >>> from lspy.aidfunc.is_improvement_func import bigger_or_equal
        >>> bigger_or_equal(2, 5)
        True
        >>> bigger_or_equal(5, 2)
        False
...
def smaller_or_equal(old_value, value):
    ...
    .. doctest::
        ...
        >>> from lspy.aidfunc.is_improvement_func import smaller_or_equal
