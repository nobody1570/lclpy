from lspy.termination.abstract_termination_criterion \
...
class MultiCriterion(AbstractTerminationCriterion):
    ...
    MaxSecondsTerminationCriterion stops the iterating:
     ...
     .. doctest::
        ...
        >>> from lspy.termination.no_improvement_termination_criterion \\
        ...     import NoImprovementTerminationCriterion
        >>> from lspy.termination.multi_criterion import MultiCriterion
        ... # init list
        >>> criteria = []
    ...
    def reset(self):
        ...
        .. doctest::
            ...
            >>> from lspy.termination.no_improvement_termination_criterion \\
            ...     import NoImprovementTerminationCriterion
            >>> from lspy.termination.multi_criterion \\
